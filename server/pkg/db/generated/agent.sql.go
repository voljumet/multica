...
const setAgentPaused = `-- name: SetAgentPaused :one
UPDATE agent
...
func (q *Queries) SetAgentPaused(ctx context.Context, arg SetAgentPausedParams) (Agent, error) {
	row := q.db.QueryRow(ctx, setAgentPaused, arg.ID, arg.Paused)
	var i Agent
	err := row.Scan(
		&i.ID,
		&i.WorkspaceID,
